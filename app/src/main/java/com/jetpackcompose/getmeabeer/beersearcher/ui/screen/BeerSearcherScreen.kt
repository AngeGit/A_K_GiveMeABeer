...
import com.jetpackcompose.getmeabeer.beersearcher.ui.body.Body
import com.jetpackcompose.getmeabeer.commontools.ui.Footer
...
fun BeerSearcherScreen(beerSearcherViewModel: BeerSearcherViewModel) {
    ...
    Column(
        ...
        if(isLoading){
            ...
            Header(stringResource(R.string.header_title), Modifier.weight(1f)) { activity.finish() }
